...
final class ApiKernel
{
    ...
    private function registerRoutes(Router $router): void
    {
        ...
        $users = new UsersController($usersRepo, $jwt, $auth, $upload, $googleVerifier);
        ...
        // users
        $router->add('GET', "$v1/auth/google/config", fn(Request $r) => $users->googleAuthConfig($r));
        ...
        $router->add('POST', "$v1/users/login/google", fn(Request $r) => $users->loginGoogle($r));
        ...
        $router->add('POST', "$v1/trips/{id}/share/reddit", fn(Request $r, array $p) => $trips->autoPublishReddit($r, $p));
