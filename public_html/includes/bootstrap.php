...
function siteMarkdownDocuments(): array
{
    ...
    $documents = [
        ...
        'android-studio-setup' => [
            ...
            'url' => 'android-studio-setup.php',
            'source' => $root . '/mobile/ANDROID_STUDIO_SETUP.md',
        ],
        'playstore-release' => [
            'slug' => 'playstore-release',
            'title' => 'Play Store Release',
            'label' => 'Play Store Release',
            'url' => 'playstore-release.php',
            'source' => $root . '/mobile/PLAYSTORE_RELEASE.md',
        ],
        'play-console-data-safety' => [
            'slug' => 'play-console-data-safety',
            'title' => 'Play Console Data Safety',
            'label' => 'Play Console Data Safety',
            'url' => 'play-console-data-safety.php',
            'source' => $root . '/mobile/PLAY_CONSOLE_DATA_SAFETY.md',
        ],
        'release-v17-checklist' => [
            'slug' => 'release-v17-checklist',
            'title' => 'Release v17 Checklist',
            'label' => 'Release v17 Checklist',
            'url' => 'release-v17-checklist.php',
            'source' => $root . '/mobile/RELEASE_V17_CHECKLIST.md',
        ],
        'mobile-readme' => [
            'slug' => 'mobile-readme',
            'title' => 'Mobile README',
            'label' => 'Mobile README',
            'url' => 'mobile-readme.php',
            'source' => $root . '/mobile/README.md',
        ],
    ];
