...
# Eliminación de cuenta (producción)

La guía pública para eliminación de cuenta está integrada en:

- `public_html/eliminar-cuenta.php`

URL esperada en producción:

- `https://www.barcostop.net/eliminar-cuenta.php`

Usa esa URL en Google Play Console para el requisito de eliminación de cuenta.
